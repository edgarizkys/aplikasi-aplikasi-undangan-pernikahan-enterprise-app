# Aplikasi Aplikasi Undangan Pernikahan Enterprise

ðŸ’’ Sistem Manajemen Undangan Pernikahan Enterprise - World-Class Enterprise v5.0
...
## Entities
- **Daftar Tamu & RSVP**: Nama Tamu, Hubungan, Jumlah Orang, Konfirmasi (Hadir/Tidak), Catatan
- **Vendor & Partner**: Nama Vendor, Kategori Layanan, Biaya (Rp), Kontak, Status Kontrak
- **Anggaran & Pengeluaran**: Item Pengeluaran, Anggaran (Rp), Realisasi (Rp), Status Bayar
